<%-- 
    Document   : ViewFilesByOwner
    Created on : Nov 22, 2019, 12:58:38 PM
      ...
      <div class="main">
        <div class="featured">
          ...
          <table cellspacing="10">
              <tr>
                  <th colspan="6" style="font-size: 20px;">View Uploaded Files By Data Owner</th>
              </tr>
              <tr>
                  <th>File Id</th>
                  <th>File Name</th>
          ...
          <%
              ps=con.prepareStatement("select u.fileid,u.filename,u.uploadeddate,u.filekey,c.co_ownerid,u.accesspolicy from UploadFiles u,Co_Ownerfile c where userid=? and u.fileid=c.fileid");

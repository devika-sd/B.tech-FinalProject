<%-- 
    ...
    Created on : Nov 25, 2019, 11:25:49 AM
      ...
      <div class="main">
        <div class="featured">
          ...
          <table cellspacing="10">
              <tr>
                  <th colspan="6" style="font-size: 20px;text-align: center;">View Files By Data Accessor</th>
              </tr>
              <tr>
                  <th>File Id</th>
                  <th>File Name</th>
          ...
          <%
              ps=con.prepareStatement("select f.fileid,f.filename,u.userid,u.uploadeddate,f.filekey from FileAccessors f, UploadFiles u where f.dataAccessor=? and f.fileid=u.fileid");
          ...
          <tr>
              ...
              <td style="text-align: center;"><a href="Download.jsp?fileid=<%=fileid%>">Verify & Download</a></td>
          </tr>
          <%
              }
              rs.close();

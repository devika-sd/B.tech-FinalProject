<%-- 
    Document   : DisseminateFiles
    Created on : Nov 23, 2019, 5:15:25 PM
      ...
      <div class="main">
        <div class="featured">
          ...
          <table cellspacing="10">
              <tr>
                  <th colspan="6" style="font-size: 20px;">View Uploaded Files by Admin(Disseminator)</th>
              </tr>
              <tr>
                  <th>File Id</th>
                  <th>File Name</th>
          ...
          <%
              ps=con.prepareStatement("select * from UploadFiles where fileid in (select distinct(fileid) from co_ownerpolicies)");
              rs=ps.executeQuery();
              while(rs.next()){
                  fileid=rs.getInt(1);
          %>
          <tr>
              ...
              <td><a href="CheckUsers.jsp?fileid=<%=fileid%>">Check User's State</a></td>
          </tr>
          <%
              }
              rs.close();
          ...
          <table cellspacing="10">
              <tr>
                  <th colspan="6" style="font-size: 20px;">View File Policies By Admin(Disseminator)</th>
              </tr>
              <tr>
                  <th>File Id</th>
                  <th>Co-Owner Id</th>

<%-- 
    Document   : ViewCo_OwnerAttributes
    Created on : Nov 22, 2019, 12:59:06 PM
      ...
      <div class="main">
        <div class="featured">
          ...
          <table cellspacing="10">
              <tr>
                  <th colspan="7" style="font-size: 20px;">View Co-Owner Conditions for the Files</th>
              </tr>
              <tr>
                  <th>File Id</th>
                  <th>Co-Owner Id</th>
                  <th>Policy1(Technology)</th>
                  <th>Policy2(Exp in Yrs)</th>
                  <th>Policy3(Domain)</th>
                  <th>Policy4(Efficiency)</th>
              </tr>
          <%
              ps=con.prepareStatement("select * from co_ownerPolicies");
              rs=ps.executeQuery();
              while(rs.next()){
          %>
          <tr>
